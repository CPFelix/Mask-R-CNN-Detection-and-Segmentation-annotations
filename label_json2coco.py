...
class labelme2coco(object):
    ...
    def image(self,data,num,json_file):
        ...
        image['file_name'] = str(json_file).split('\\')[-1].split('.')[-2] + '.jpg'
        self.height=height
        self.width=width
...
labelme_json=glob.glob('F:/mango_new/all/train_images_json/json/*.json')
# labelme_json=['./1.json']
save_json_path = 'F:/mango_new/all/mango_train_76.json'
